  ...
  return (
    <main className="access-page agency-access">
      <header className="access-topbar">
        <div className="access-brand"><span className="sifunnel-icon"><img src="/brand/sifunnel-mark.svg" alt="" /></span><strong>SiFunnel</strong></div>
      ...
      <div className="access-layout">
        <section className="access-intro">
          ...
          <div className="access-preview" aria-hidden="true">
            <header><div><span className="preview-logo sifunnel-icon"><img src="/brand/sifunnel-mark.svg" alt="" /></span><strong>{t("auth.previewTitle")}</strong></div><small>{t("auth.previewToday")}</small></header>
