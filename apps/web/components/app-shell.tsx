...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  if (loading || !user) return <div className="app-loader"><span className="sifunnel-icon"><img src="/brand/sifunnel-mark.svg" alt="" /></span><span>{t("shell.loading")}</span></div>;
    ...
    <div className="app-layout">
      ...
      <aside className={`sidebar ${mobileOpen ? "sidebar-open" : ""}`}>
        <div className="brand-row">
          <Link href="/" className="brand"><span className="sifunnel-icon"><img src="/brand/sifunnel-mark.svg" alt="" /></span><span>SiFunnel</span></Link>
