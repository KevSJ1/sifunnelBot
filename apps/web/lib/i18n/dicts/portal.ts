...
const en = {
  ...
  settings: {
    templatesCopy: "Create reusable replies for your team and optionally make them available to the AI agent. WhatsApp-approved templates remain available below.",
  },
  templates: {
  ...
  canned: {
    ...
    manageDescription: "Create reusable replies for human operators. Enable AI use when the agent may use the template in a conversation.",
    new: "New template",
    edit: "Edit",
    delete: "Delete",
    deleteConfirm: "Delete",
    duplicate: "A template already uses that shortcut.",
    aiBadge: "AI",
    form: {
      shortcut: "Shortcut",
      ...
      aiEnabled: "Available to AI agents",
      aiEnabledHelp: "The agent may use this template when it matches the customer's intent.",
      save: "Save template",
    },
  },
  reports: {
...
const es: typeof en = {
  ...
  settings: {
    templatesCopy: "Crea respuestas reutilizables para tu equipo y, si quieres, habilítalas para el agente de IA. Las plantillas aprobadas de WhatsApp siguen disponibles abajo.",
  },
  templates: {
  ...
  canned: {
    ...
    templatesTitle: "Templates",
    manageTitle: "Templates",
    manageDescription: "Crea respuestas reutilizables para operadores humanos. Habilita el uso por IA cuando el agente pueda usar la plantilla en una conversación.",
    new: "Nueva plantilla",
    edit: "Editar",
    delete: "Eliminar",
    deleteConfirm: "Eliminar",
    duplicate: "Ya hay una plantilla con ese atajo.",
    aiBadge: "IA",
    form: {
      shortcut: "Atajo",
      ...
      aiEnabled: "Disponible para agentes de IA",
      aiEnabledHelp: "El agente puede usar esta plantilla cuando coincida con la intención del cliente.",
